...
public class Proprietario {
	...
	// C'è una sola istanza della classe Proprietario che serve per gestire il sistema, ma si è scelto di non renderla statica
	// perché contiene collezioni il cui stato è mutevole
